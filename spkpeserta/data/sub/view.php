 <div id="content-header">
  ...
  <div class="container-fluid">
    ...
    <div class="row-fluid">
      <div class="span12">
       <a href="?load=sub&action=input"><button class="btn btn-success" disabled><i class="icon-plus"></i> &nbsp; Tambah Data</button></a>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
			   ...
			   while($_data=mysqli_fetch_array($SQL)){
                  ...
                  <td class='center'>  
           <a href='?load=sub&action=edit&id=$_data[id_sub]'><button class='btn btn-primary'> <i class='icon-pencil'></i> &nbsp; Edit</button></a>
