        ...
        <div class="widget-box">
              ...
              <div class="span6">
                <table class="table table-bordered table-invoice">
                  <tbody>
                    ...
                    <tr>
                    <?php
					$query=mysqli_query($koneksi,"SELECT MAX (noOrder) As nomorOrder FROM tboking");
          ...
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
               <?php
			   $SQL=mysqli_query($koneksi,"SELECT * FROM tjadwal,tlapangan,tjam WHERE 
              ...
              <div class="span12">
                <table class="table table-bordered table-invoice-full">
                 ...
                 <th>Aksi</th>
                  ...
                  <tbody>
                    <?php
			   $SQL=mysqli_query($koneksi,"SELECT * FROM tboking_temp WHERE idSession='$_SESSION[username]'");
			   $no=1;
			   if($no % 2==1){
					   $class="gradeU";
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="right"><strong>Total Bayar</strong> <br>
                        ...
                        <?php
						$to=mysqli_query($koneksi,"SELECT SUM(subTotalTemp) AS subtotal FROM tboking_temp WHERE idSession='$_SESSION[username]'");
