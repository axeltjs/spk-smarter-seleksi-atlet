 <?php
 $SQL =mysqli_query($koneksi,"SELECT * FROM tboking WHERE usernameboking='$_SESSION[username]'");
 ...
 echo"
  ...
  <tbody>
	...
	$rincian=mysqli_query($koneksi,"SELECT * FROM trincian_boking WHERE kdBoking='$_data[kdBoking]'");
