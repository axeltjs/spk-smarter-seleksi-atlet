      ...
      <div class="widget-box">
		...
		echo '<option'.($i==date('Y')?' selected':'').' value="'.$i.'">'.$i.'</option>';
			...
			<div class="control-group">
              ...
              <div class="controls">
               <ul style="list-style:none;margin:10px 0 0">
	<li><input id="op_semua" checked type="radio" class="" name="op_lap" value="hasil"/><label for="op_s">&nbsp; Pendaftar yang Lulus</label></li>
	</ul>
              </div>
            </div>
		...
		echo '<option'.($i==date('Y')?' selected':'').' value="'.$i.'">'.$i.'</option>';
			...
			<div class="control-group">
              ...
              <div class="controls">
               <ul style="list-style:none;margin:10px 0 0">
	<li><input id="op_semua" checked type="radio" class="" name="op_lap" value="hasil"/><label for="op_s">&nbsp; Pendaftar yang Tidak Lulus</label></li>
	</ul>
              </div>
            </div>
