...
<p align="center" class="style1">Laporan Data Pengumuman Pendaftar Yang TIDAK LAYAK Per Periode Tahun <?php echo $tgl1?> </p>
...
$no=1;
$tampil = mysqli_query($koneksi,"SELECT * FROM hasil where  thn_hitung ='$tgl1' AND ket='TIDAK LAYAK' order by rank DESC") or die(mysqli_error($koneksi));
