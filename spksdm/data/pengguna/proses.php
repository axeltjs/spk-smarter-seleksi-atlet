...
if($ketemu > 0){
	...
	";
		...
		VALUES ('$_POST[idp]','$_POST[txtuser]','$_POST[txtpass]','$_POST[txtNmLengkap]','$filename','$_POST[txtemail]','$_POST[txtAlamat]','$_POST[txtKontak]','Y','$_POST[level]')")or die(mysqli_error($koneksi));
