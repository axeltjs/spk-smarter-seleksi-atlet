...
--
-- Host: 127.0.0.1
-- Generation Time: May 23, 2019 at 02:43 PM
...
INSERT INTO `hasil` (`id_calon`, `nama`, `thn_hitung`, `jpendidikan`, `usia`, `pengalaman`, `nilaites`, `wawancara`, `kesehatan`, `nreal`, `rank`, `n1`, `n2`, `n3`, `n4`, `h1`, `h2`, `h3`, `h4`, `h5`, `h6`, `ket`, `u1`, `u2`, `u3`, `u4`, `u5`, `u6`) VALUES
...
INSERT INTO `kriteria` (`id_kriteria`, `nama_kriteria`, `prioritas`, `bobot`) VALUES
...
INSERT INTO `kriteria1` (`id_kriteria`, `nama_kriteria`, `prioritas`, `bobot`) VALUES
...
INSERT INTO `peserta` (`id_calon`, `username`, `pass`, `foto`, `cv`, `blm_nikah`, `ijazah`, `transkrip`, `buktip`, `skck`, `suratkesehatan`, `ktp`, `aktif`, `status`, `validasi`, `validasi1`, `nama`, `no_hp`, `email`, `alamat`, `tgl_input`, `tgl_lhr`, `tempat_lhr`, `jenkel`, `jpendidikan`, `usia`, `pengalaman`, `nilaites`, `wawancara`, `kesehatan`, `n1`, `n2`, `n3`, `n4`) VALUES
...
INSERT INTO `sub_kriteria` (`id_sub`, `nama_sub`, `prioritas`, `bobot`, `nama_kriteria`) VALUES
...
INSERT INTO `tpengguna` (`kdPengguna`, `username`, `password`, `nmPengguna`, `foto`, `emailPengguna`, `alamatPengguna`, `kontak`, `aktif`, `level`) VALUES
('P0001', 'admin', '123', 'Adam Damara', 'guy-5.jpg', 'xxx@gmail.com', 'jln adi sucipto', '089877377868', 'Y', 'admin'),
('P0002', 'Pinca', '123', 'raihan r marpaung', 'guy-8.jpg', 'xxxpinca@gmail.com', 'jln kemakmuran', '90897868453', 'Y', 'Pimpinan');
...
INSERT INTO `utility` (`id_calon`, `nama`, `hasil`) VALUES
('A0001', 'yayan', 71),
('A0002', 'ria', 65),
('A0003', 'yayan', 69);
...
--
-- Indexes for table `kriteria1`
--
ALTER TABLE `kriteria1`
  ADD PRIMARY KEY (`id_kriteria`);
