...
<p align="center">&nbsp;</p>
<p align="center">&nbsp;</p>
<p align="center"><img src="gbr.jpg" width="1016" height="118"></p>
<p align="center" class="style1">LAPORAN DATA Hasil Perhitungan</p>
...
$no=1;
$tampil = mysqli_query($koneksi,"SELECT * FROM hasil where  tgl_input ='$tgl1' order by id_calon DESC") or die(mysqli_error($koneksi));
